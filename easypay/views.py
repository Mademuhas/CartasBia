...
class EscolhasListView(generic.ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        lista = Escolha.objects.all().order_by(Escolha.data)
        size = len(lista) - 1
        context['obj1'] = f'easypay/images/{lista[size]}'
        context['obj2'] = f'easypay/images/{lista[size-1]}'
        context['obj3'] = f'easypay/images/{lista[size-2]}'
        context['obj4'] = f'easypay/images/{lista[size-3]}'
        context['obj5'] = f'easypay/images/{lista[size-4]}'
